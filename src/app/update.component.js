...
var UpdateUserComponent = (function () {
    function UpdateUserComponent(updateService) {
        this.updateService = updateService;
        //@Input("allU") allu:User[];
        //;
        this.us = { name: "", email: "", project: "" };
        this.flagType = false;
        this.nameModel = '';
    ...
    UpdateUserComponent.prototype.myFirstBlur = function (evt) {
        evt.preventDefault();
        alert(evt.target.textContent);
    };
    UpdateUserComponent.prototype.myClicking = function (evt) {
        evt.preventDefault();
        evt.stopPropagation();
...
UpdateUserComponent = __decorate([
    core_1.Component({
        ...
        providers: [update_service_1.UpdateUserService],
    ...
    __metadata("design:paramtypes", [update_service_1.UpdateUserService])
], UpdateUserComponent);
